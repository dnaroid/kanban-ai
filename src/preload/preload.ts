...
const api: MainToRenderer = {
  ...
  board: {
    ...
    updateColumns: (boardId, columns) => ipcRenderer.invoke('board:updateColumns', { boardId, columns })
  },
  task: {
    ...
    move: (taskId, toColumnId, toIndex) => ipcRenderer.invoke('task:move', { taskId, toColumnId, toIndex })
  },
  diagnostics: {
