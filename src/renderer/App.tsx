...
import { Layout, Activity, FolderKanban, Settings, Github, Database, AlertTriangle } from 'lucide-react'
import { ProjectsScreen } from './screens/ProjectsScreen'
import { DiagnosticsScreen } from './screens/DiagnosticsScreen'
import { cn } from './lib/utils'

type Screen = 'projects' | 'diagnostics'
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <main className="pl-64 min-h-screen">
        <header className="h-16 border-b border-slate-800/30 bg-[#0B0E14]/80 backdrop-blur-md sticky top-0 z-40 flex items-center px-8 justify-between">
          <div className="flex items-center gap-2 text-sm text-slate-500">
             <span>Main</span>
             <span className="text-slate-700">/</span>
             <span className="text-slate-300 capitalize">{currentScreen}</span>
          </div>
