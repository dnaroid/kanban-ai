      ...
      <div className="relative">
        <button
          ...
          className={cn(
            ...
            isOpen && 'ring-1 ring-offset-1 ring-offset-[#0B0E14] ring-slate-700'
          )}
        >
          <currentOption.icon className={cn('w-3.5 h-3.5', currentOption.color)} />
          <span
            className={cn('text-[11px] font-bold uppercase tracking-wider', currentOption.color)}
          >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected || isHovered ? cn(opt.bg, opt.color) : cn(opt.color, 'opacity-70')
                    )}
                  >
                    <opt.icon
                      className={cn(
