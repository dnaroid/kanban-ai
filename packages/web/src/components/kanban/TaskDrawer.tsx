...
import { TaskDrawerRuns } from "@web/components/kanban/drawer/TaskDrawerRuns";
import { TaskDrawerProperties } from "@web/components/kanban/drawer/TaskDrawerProperties";
import { TaskDrawerDetails } from "@web/components/kanban/drawer/TaskDrawerDetails";
...
export function TaskDrawer({
	...
	const [activeTab, setActiveTab] = useState<
		"details" | "vcs" | "runs" | "chat" | "properties"
	>("details");
	const [isEditingTitle, setIsEditingTitle] = useState(false);
	const [editedTitle, setEditedTitle] = useState("");
	const titleInputRef = useRef<HTMLInputElement>(null);
	const [isExpanded, setIsExpanded] = useState(
		uiStore.getSettings().taskDrawerExpanded,
	);
	...
	useEffect(() => {
		uiStore.setTaskDrawerExpanded(isExpanded);
	}, [isExpanded]);
