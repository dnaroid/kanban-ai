...
export function buildTaskPrompt(
	...
	return [
		...
		"Before the REPORT tag, include a structured summary using these markdown headers:",
		"## Summary — Brief overview of what you did",
		"## Changed Files — List every file modified/created/deleted (one per line, prefixed with -)",
		"## Test Results — Test outcomes with pass/fail/skipped counts if tests were run",
		"## Errors — List any errors encountered (omit section if none)",
		"## Warnings — List any warnings encountered (omit section if none)",
		"Then your LAST line MUST be exactly one REPORT tag:",
		...
		"Put your summary BEFORE the REPORT tag.",
