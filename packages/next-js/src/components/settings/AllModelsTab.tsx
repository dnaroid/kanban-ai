				...
				<div className="flex items-center gap-3 flex-wrap">
					...
					<div className="relative">
						...
						<input
							...
							className="pl-10 pr-4 py-2.5 bg-[#161B26] border border-slate-700 rounded-xl text-sm text-slate-200 hover:border-slate-600 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/50 transition-all w-48 placeholder:text-slate-500 shadow-sm"
						/>
					</div>
					...
					allProviders.map((provider) => {
						...
						return (
							...
							>
								...
								>
									<div
										className="flex items-center gap-3 cursor-pointer flex-1 hover:bg-white/5 rounded-lg transition-colors"
									...
									<button
										...
										className={cn(
											"w-8 h-4.5 rounded-full transition-all relative flex items-center px-1 cursor-pointer hover:opacity-80",
										)}
										style={{
										...
										{group.models.map((model) => {
											...
											return (
												<button
													...
													className={cn(
														"group relative p-4 rounded-xl border transition-all cursor-pointer hover:border-slate-600 hover:shadow-lg",
													)}
													style={{
