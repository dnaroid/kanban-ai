							...
							{task.description && task.description.trim().length > 0 && (
								<>
									...
									<button
										...
										className="w-8 h-8 flex items-center justify-center bg-cyan-600/10 hover:bg-cyan-600 text-cyan-400 hover:text-white rounded-lg transition-all border border-cyan-500/20 hover:border-cyan-500"
